...
for pokemon_name in all_pokemon_names[:151]:
...
try:
    ...
    # Create the PokemonData table if not exists
    create_table_query = """
    ...
    # Create a new table for PokemonTypeDamageTaken 
